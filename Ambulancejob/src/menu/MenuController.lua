        ...
        if RageUI.CurrentMenu() then
            ...
            if RageUI.Options > RageUI.CurrentMenu.Pagination.Total then
                ...
                if RageUI.CurrentMenu.EnableMouse   then
                    ...
                    if UpHovered then
                        RenderRectangle(RageUI.CurrentMenu.X, RageUI.CurrentMenu.Y + RageUI.CurrentMenu.SubtitleHeight + RageUI.ItemOffset, RageUI.Settings.Items.Navigation.Rectangle.Width + RageUI.CurrentMenu.WidthOffset, RageUI.Settings.Items.Navigation.Rectangle.Height, 150, 134, 12, 255)
                    else
